...
namespace HotelReservationsManager.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string firstName, string lastName)
        {
            ...
            {
                clients = clients.Where(c => c.FirstName.Contains(firstName)).ToList();
            }
            if (!String.IsNullOrEmpty(lastName))
            {
                clients = clients.Where(c => c.LastName.Contains(lastName)).ToList();
            }

            ViewData["Reservations"] = _context.ClientReservations;
            return View(clients);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var clientReservation = _context.ClientReservations.Where(cr => cr.ClientId == id).ToList();
